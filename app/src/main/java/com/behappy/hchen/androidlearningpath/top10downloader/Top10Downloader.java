package com.behappy.hchen.androidlearningpath.top10downloader;
...
public class Top10Downloader extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadData(String.format(feedUrl, feedLimit));
    }
        ...
        switch (id) {
            ...
            case R.id.menu25:
                if (!item.isChecked()) {
                    ...
                    Log.d(TAG, "onOptionsItemSelected: "+item.getTitle()+" setting feedLmit to "+feedLimit);
                } else {
    ...
    private void downloadData(String feedUrl) {
        if (!feedUrl.equalsIgnoreCase(feedCachedUrl)) {
            Log.d(TAG, "downloadData: starting Asynctask");
            DownloadData downloadData = new DownloadData();
            downloadData.execute(feedUrl);
            Log.d(TAG, "downloadData: done");   
        } else {
            Log.d(TAG, "downloadData: URL not changed");
        }
    }
